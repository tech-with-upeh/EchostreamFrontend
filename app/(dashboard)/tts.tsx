    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top', 'left', 'right']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {activeTab === 0 ? <>
          ...
          <View style={[styles.card, { backgroundColor: theme.surfaceVariant, borderColor: theme.outline }]}><ToggleRow icon={<Ionicons name="happy-outline" size={18} color={theme.onSurfaceVariant} />} label={<View style={styles.paidLabelRow}><Text style={{ color: theme.onSurface }}>Convert Emojis to Words</Text><MaterialCommunityIcons name="crown" size={12} color="#FFB961" /></View> subtitle={'e.g. "🔥" becomes "fire"'} value={convertEmojis} onValueChange={setConvertEmojis} /><View style={[styles.rowDivider, { backgroundColor: theme.outline }]} /><ToggleRow icon={<Ionicons name="shield-outline" size={18} color={theme.onSurfaceVariant} />} label={<View style={styles.paidLabelRow}><Text style={{ color: theme.onSurface }}>Filter Profanity</Text><MaterialCommunityIcons name="crown" size={12} color="#FFB961" /></View> subtitle="Skip messages containing blocked words" value={filterProfanity} onValueChange={setFilterProfanity} /><View style={[styles.rowDivider, { backgroundColor: theme.outline }]} /><ToggleRow icon={<Ionicons name="terminal-outline" size={18} color={theme.onSurfaceVariant} />} label={<View style={styles.paidLabelRow}><Text style={{ color: theme.onSurface }}>Require Command Prefix</Text><MaterialCommunityIcons name="crown" size={12} color="#FFB961" /></View> subtitle="Only read messages that start with a command" value={requireCommand} onValueChange={setRequireCommand} />{requireCommand && <TextInput value={commandText} onChangeText={setCommandText} placeholder="!tts" placeholderTextColor={theme.onSurfaceVariant} autoCapitalize="none" autoCorrect={false} style={[styles.commandInput, { color: theme.onSurface, borderColor: theme.outline, backgroundColor: theme.surface }]} />}<View style={[styles.rowDivider, { backgroundColor: theme.outline }]} /><Stepper label="Max Message Length" value={maxMessageLength} onChange={setMaxMessageLength} min={20} max={500} step={10} unit=" chars" /></View>
