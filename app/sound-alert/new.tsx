...
export default function NewSoundAlertScreen() {
  ...
  const filteredSounds = useMemo(() => SYSTEM_SOUNDS.filter(s => s.name.toLowerCase().includes(soundSearch.trim().toLowerCase())), [soundSearch]);
