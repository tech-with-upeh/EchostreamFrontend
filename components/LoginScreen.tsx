...
export default function LoginScreen() {
  ...
  const loginTextStyle = useAnimatedStyle(() => ({
    color: interpolateColor(
      tabProgress.value,
      [0, 1],
      [theme.buttonText, theme.onSurfaceVariant],
    ),
  }));
  const registerTextStyle = useAnimatedStyle(() => ({
    color: interpolateColor(
      tabProgress.value,
      [0, 1],
      [theme.onSurfaceVariant, theme.buttonText],
    ),
  }));
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Animated.Text style={[styles.tabButtonText, loginTextStyle]}>
            Login
          </Animated.Text>
        </Pressable>
        <Pressable
        ...
        >
          <Animated.Text style={[styles.tabButtonText, registerTextStyle]}>
            Register
          </Animated.Text>
        </Pressable>
      </Animated.View>
        ...
        {isLogin && (
          ...
          >
            ...
            <Pressable onPress={() => router.push("/forgot-password")}>
              <Text
                style={[styles.forgotPassword, { color: theme.primaryDim }]}
              >
                Forgot Password?
              </Text>
            </Pressable>
      ...
      >
        ...
        >
          <View
            style={[styles.dividerLine, { backgroundColor: theme.outline }]}
          />
        ...
        <View style={styles.socialRow}>
          ...
          >
            ...
            >
              ...
              <Text
                style={[styles.socialButtonText, { color: theme.onSurface }]}
              >
                Google
              </Text>
            </Pressable>
