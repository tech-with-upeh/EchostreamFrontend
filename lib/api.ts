...
export function setAuthTokens(tokens: TokenResponse) { accessToken = tokens.access_token; refreshToken = tokens.refresh_token; }
export function getAccessToken() { return accessToken; }
export function clearAuthTokens() { accessToken = null; refreshToken = null; }
